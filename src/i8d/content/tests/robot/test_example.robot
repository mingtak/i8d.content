...
#
#  $ bin/test -s i8d.content -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src i8d.content.testing.I8D_CONTENT_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/i8d/content/tests/robot/test_example.robot
#
